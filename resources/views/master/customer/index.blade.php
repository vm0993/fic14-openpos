...
@section('content')
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{ route('masters.customer.create') }}"
            ...
            <table class="display table-striped -mt-2" id="datatable" width="100%">
                <thead>
                    <tr>
                        ...
                        <th class="px-4 py-2 w-56">Shop.Amount</th>
...
@section('footer')
    ...
    <script type="text/javascript">
        var url = "{{ route('masters.customer.index') }}";
        ...
        var tableCategory = $('#datatable').DataTable({
            ...
            columns: [
                ...
                { data:'shop_amount', name:'shop_amount', className: 'text-xs text-right' },
