...
@section('content')
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{ route('inventorys.item-incoming.create') }}"
...
@section('footer')
    ...
    <script type="text/javascript">
        var url = "{{ route('inventorys.item-incoming.index') }}";
        ...
        $('input[name="date_range"]').daterangepicker({
            ...
            $('#exportPDF').attr('href', '/inventorys/item-incoming/' + first.format('YYYY-MM-DD') + '+' + last.format('YYYY-MM-DD') + '/preview')
            $('#exportXls').attr('href', '/inventorys/item-incoming/' + first.format('YYYY-MM-DD') + '+' + last.format('YYYY-MM-DD') + '/download-xls')
        });

        $('#exportPDF').attr('href', '/inventorys/item-incoming/' + $('input[name="date_range"]').data('daterangepicker').startDate.format('YYYY-MM-DD') + '+' + $('input[name="date_range"]').data('daterangepicker').endDate.format('YYYY-MM-DD') + '/preview');
        $('#exportXls').attr('href', '/inventorys/item-incoming/' + $('input[name="date_range"]').data('daterangepicker').startDate.format('YYYY-MM-DD') + '+' + $('input[name="date_range"]').data('daterangepicker').endDate.format('YYYY-MM-DD') + '/download-xls')
